...
const Header = () => {
    const { toggleTheme, theme } = useContext(ThemContext)
    ...
    const menuItems =
        <React.Fragment>
            ...
            <li>
                <label className="swap swap-rotate" onChange={() => toggleTheme()} checked={theme} >                   <input type="checkbox" />
